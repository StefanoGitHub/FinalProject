				    ...
				    <article>
						<div id="about">
							<div>
								...
								<p>Version 2<br>
								Website Template details, discussion and updates for this <a href="http://www.freewebsitetemplates.com/discuss/wellnesswebsitetemplate/">Wellness Website Template</a>.<br>
								Website Template design by <a href="http://www.freewebsitetemplates.com/">Free Website Templates</a>.<br>
								Please feel free to remove some or all the text and links of this page and replace it with your own About content.</p>
							</div>
							<div>
								<ul>
									<li class="first">
										<a href="blog.html"><img src="images/finger-nails.jpg" alt=""/></a>
									...
									<li>
										<a href="blog.html"><img src="images/face-treatment.jpg" alt=""/></a>
										<span><a href="blog.html">Lorem Ipsum</a></span>
										<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque posuere consectetur sapien, eu rhoncus ante pellen</p>
									</li>
									<li>
										<a href="blog.html"><img src="images/back-massage.jpg" alt=""/></a>
										<span><a href="blog.html">Lorem Ipsum</a></span>
										<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque posuere consectetur sapien, eu rhoncus ante pellen</p>
									</li>
								</ul>
